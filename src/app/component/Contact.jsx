      ...
      <div id="contact-section" className="mt-24 mb-10">
        <div className="flex flex-col gap-10">
          <div className="flex flex-col gap-4">
            <h1 className="font-bold text-center md:text-start text-2xl mb-10 text-[#011638] md:border-l-[7px] md:pl-2 md:border-[#D499B9] uppercase">Let&apos;s Connect</h1>
          ...
          <div className="flex flex-wrap justify-center gap-6 md:gap-16 lg:gap-24 rounded border bg-gradient-to-t from-[#2E294E] to-[#9055A2] shadow-lg py-4">
            <div className="flex items-center md:justify-between justify-center gap-3">
              ...
              <span className="no-underline  cursor-pointer text-white text-sm transition hover:no-underline hover:text-[#D499B9]">Abdu.alyousef95@gamil.com</span>
            </div>
            <div className="flex items-center justify-center gap-3">
              ...
              <span className="no-underline hover:no-underline cursor-pointer text-white transition hover:text-[#D499B9]  text-sm">004915731073866</span>
            </div>
          </div>
        </div>
      </div>
