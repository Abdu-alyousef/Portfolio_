    ...
    <Container>
      <div id="contact-section" className="mt-24 mb-10">
        <div className="flex flex-col gap-10">
          ...
          <div className="flex flex-wrap justify-center gap-6 md:gap-16 lg:gap-24 rounded border shadow-lg py-4">
            <div className="flex items-center md:justify-between justify-center gap-3">
              ...
              <p className="font-medium text-neutral-950  uppercase text-sm">Email:</p>
              </div>
              <span className="no-underline cursor-pointer text-neutral-950 text-sm transition hover:text-yellow-700">Abdu.alyousef95@gamil.com</span>
            </div>
            <div className="flex items-center justify-center gap-3">
                <div className="flex items-center gap-2">
              <Image src="/call.svg" alt="Logo" width={20} height={20} />
              <p className="font-medium uppercase text-neutral-950  text-sm">PHONE:</p>
              </div>
              <span className="no-underline cursor-pointer text-neutral-950 transition hover:text-yellow-700  text-sm">004915731073866</span>
            </div>
          </div>
        </div>
      </div>
