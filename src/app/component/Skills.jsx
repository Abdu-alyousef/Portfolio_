...
export default function Skills  () {
    return (
        <Container>
        <div  className="mt-10">
            <div className="border flex flex-col items-center gap-12 py-10 rounded overflow-hidden shadow-lg c-bg ">
                <h1 className="font-bold text-2xl uppercase- text-white border-l-[7px] pl-2 border-pink-400">Skills</h1>
                <div className="flex flex-col gap-4 px-6">
                <p className="font-semibold text-gray-50">My expertise encompasses a wide array of frontend technologies, including:</p>
                <ul className="list-disc text-gray-100 text-sm pl-5">
