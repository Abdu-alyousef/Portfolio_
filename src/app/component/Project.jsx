...
export default function Project() {
  return (
    <Container>
      <div className="mt-20">
        <h2 className="text-2xl text-center md:text-start mb-10 font-bold uppercase text-[#011638] md:border-l-[7px] md:pl-2 md:border-[#D499B9]">
          See my all Projects
        </h2>
        <p className=" text-slate-800 mb-4 text-center md:text-start">
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 pb-10">
          <div className="rounded overflow-hidden shadow-xl mt-5 relative bg-white">
            <Image src="/food.png" alt="food" width={600} height={400} />
            <div className="px-6 py-2">
              <div className="font-semibold text-xl mb-2 text-[#011638]">
                FOOD APP
              </div>
            ...
            <div className="px-6 py-4">
              <Link
                ...
                target="_blank"
                className="bg-[#9055A2] transition hover:bg-[#D499B9] text-white font-light py-2 px-4 rounded"
              >
                See demo
              </Link>
            </div>
            <div className="absolute text-slate-700 bg-gray-100 top-4 left-2 px-3 py-1 rounded-full">
              <span>NextJs</span>
            </div>
          </div>
          ...
          <div className="object-cover rounded overflow-hidden shadow-xl mt-5 relative bg-white">
            <Image
              src="/dream.png"
              alt="dream website"
              width={600}
