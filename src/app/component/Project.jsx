  ...
  return (
    <Container>
      <div className="mt-20">
        ...
        <p className=" text-slate-800 mb-4 text-center md:text-start">For a comprehensive view of all my work, including open-source projects and personal endeavors, head over to my GitHub profile.</p>
